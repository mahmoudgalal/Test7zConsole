...
include $(CLEAR_VARS)
LOCAL_MODULE    := S7z 
LOCAL_SRC_FILES := lib7z.so
include $(PREBUILT_SHARED_LIBRARY)
include $(CLEAR_VARS)

LOCAL_MODULE    := test7zconsole
LOCAL_CPPFLAGS := -DEXTERNAL_CODECS -D_REENTRANT -D_7ZIP_ST -DP7Z_ANDROID -D_LARGEFILE_SOURCE -D_LARGE_FILES -DUNICODE -D_UNICODE
...
LOCAL_SRC_FILES := test7zconsole.cpp ExtractGUI.cpp ExtractCallback.cpp\
